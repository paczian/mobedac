package mobedac::WebPage::MetagenomeOverview;

# $Id: MetagenomeOverview.pm,v 1.2 2012-05-30 17:55:01 tharriso Exp $
...
sub output {
  ...
  my $mg_link = "http://mobedac.org/linkin.cgi?metagenome=$mgid";
  ...
  $html .= "<p><table><tr>";
  $html .= "<td style='font-size:large;'><b>mobedac ID</b></td>";
  $html .= "<td style='font-size:large;'>&nbsp;&nbsp;&nbsp;$mgid".($user && $user->is_admin('MGRAST') ? " (".$job->job_id.")" : "")."</td>";
  $html .= "<td>&nbsp;&nbsp;&nbsp;<a class='nav_top' target=_blank href='?page=Download&metagenome=$mgid'><img src='./Html/mg-download.png' style='width:20px;height:20px;' title='Download $mgid'></a></td>";
  $html .= "<td>&nbsp;&nbsp;&nbsp;<img src='./Html/analysis.gif' style='width:20px;height:20px;' title='Analyze $mgid'> <a class='nav_top' target=_blank href='http://metagenomics.anl.gov/?page=Analysis&metagenome=$mgid' title='Analyze this metagenome in MG-RAST'>MG-RAST</a> <a href='#' onclick=\"alert('This metagenome is either not submitted to VAMPS, or the\\nanalysis is still in progress.');\" title='Analyze this metagenome in VAMPS'>VAMPS</a> <a href='#' onclick=\"alert('This metagenome is either not submitted to QIIME, or the\\nanalysis is still in progress.');\" title='Analyze this metagenome in QIIME'>QIIME</a> </td>";
  ...
  $html .= "<h2>View Analysis Results</h2><table><tr><td><b>MG-RAST</b></td><td><a href='http://metagenomics.anl.gov/linkin.cgi?metagenome=$mgid' target=_blank></td></tr><tr><td><b>VAMPS</b></td><td>$vamps_link</td></tr><tr><td><b>QIIME</b></td><td>$qiime_link></td></tr></table>";
...
<h3>Source Hits Distribution
  <a target=_blank href='?page=Sources' style='font-size:14px;padding-left:5px;'>[?]</a>
  <a style='cursor:pointer;clear:both;font-size:small;padding-left:10px;' onclick='
  if (this.innerHTML=="show") {
    this.innerHTML = "hide";
...
sub get_alpha {
  ...
  $html .= "<p>Annotated species richness is the number of distinct species annotations in the combined mobedac dataset. Shannon diversity is an abundance-weighted average of the logarithm of the relative abundances of annotated species. The species-level annotations are from all the annotation source databases used by mobedac.</p>";
...
sub chart_export_link {
  ...
  return "<a href='?page=MetagenomeOverview&metagenome=$mgid&action=chart_export&name=$name&file=$file'>$text</a>";
}
