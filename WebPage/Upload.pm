package mobedac::WebPage::Upload;
  ...
  $html .= qq~<br><br><input type='button' class='btn' value='select' onclick='select_sequence_file();'></div><div id='selected_sequences'></div></div></div>
		  ...
		  <div class="control-group">
			...
			Specify the maximum allowed number of ambiguous basepairs.
                    ...
                    <label class="control-label" for="pipelines" style="float: none;"><b>pipelines</b></label>
		    <div class="controls">
		      <label class="checkbox">
			<input id="pipeline1" type="checkbox" value="MGRAST" name="MGRAST" checked>
			MG-RAST
		      </label>
		      <label class="checkbox">
			<input id="pipeline2" type="checkbox" value="VAMPS" name="VAMPS" checked>
			VAMPS
		      </label>
		      <label class="checkbox">
			<input id="pipeline3" type="checkbox" value="QIIME" name="QIIME" checked>
			QIIME
		      </label>
		    </div>
		  </div>
...
<h3>Submit data to the selected pipelines.</h3>
